<!--
    ...
    File: GetMoviesYear.php

    Description: This file gets and displays all of the movies from the database in
    order of year
-->
...
<head>
    <meta charset="utf-8">
    <title>CS3319 - Databases - Get Movies by Year</title>
</head>
<body>
    <?php
    include 'connectdb.php';
    ?>
    <h1>PSC: Movies by Year</h1>
